...
layout: page
title: Visit Tracker
permalink: /visit-tracker/
description: Hidden visit tracking page
---
...
<script>
  (function() {
    ...
    function updateMap() {
      ...
      const validVisits = visits.filter(function(v) {
      ...
      validVisits.forEach(function(visit, index) {
    ...
    function displayVisits() {
      ...
      const uniqueLocations = new Set(visits.map(function(v) {
